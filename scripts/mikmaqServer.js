 ...
 *         Raish Raj Joshi -  Documentaion of the file,
 */
...
/*
  ...
  http://ugdev.cs.smu.ca:3055/myPost
*/
 ...
 *
 * Author: Suyog Chitrakar - Wrote initial function
 *         Raish Raj Joshi - Updated code along with with total and correct answers
 */

server.post("/myPost", function (req, res) {
  // log the "value" in the "name":"value" pair received
  console.log("req.body.incorrectAnswer: " + req.body.inAnswer);
  console.log("req.body.correcinAnswer: " + req.body.cAnswer);

  correctAnswer = req.body.cAnswer;
  incorrectAnswer = req.body.inAnswer;

  // define a new JSON objectsect to be returned
  let object = { status: "Done" };
...
/*
  ...
  request is received by this server at the endpoint
  http://ugdev.cs.smu.ca:3055/myGet
*/
